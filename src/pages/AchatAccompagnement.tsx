  ...
  const getVigilanceMessages = () => {
    ...
    if (answers.capacite === "Non" || answers.capacite === "Un peu") {
      messages.push({
        ...
        text: `Tu as indiqué ${answers.capacite === "Non" ? "ne pas mettre" : "mettre peu"} d'argent de côté. Constitue 3 à 6 mois de salaire. Nous avons un module dédié à l'épargne.`,
        priority: 3
      });
    }
